...
public class Adult {
	...
	public Adult(Integer age, String workclass, Integer fnlwgt, String education, Integer education_num, String marital_status,
			String occupation, String relationship, String race, String sex, Integer capital_gain, Integer capital_loss,
			Integer hours_per_week, String native_country, String income) {
